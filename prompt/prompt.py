...
2. Draft a dispute letter addressed to {company_name} matching the requested {letter_tone} tone. The letter should be professional, persuasive, and explicitly state the required resolution (e.g., refund, un-banning, compensation). Do not invent facts, but do formulate a strong legal/policy argument based on the provided text. Leave placeholders like [Your Name] for the user to fill in.
